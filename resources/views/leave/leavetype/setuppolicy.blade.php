...
<div id="addpolicyform" style="display:none; cursor: default">

        {!! Form::open(array('route' => 'SetupPolicy.store','method'=>'POST','data-parsley-validate')) !!} 
      ...
      <div class="box box-default">
        ...
        <div class="box-body">
              ...
              <div class="form-group">
                <label>
                  <input type="radio" name="earningmethod" class="minimal"   onclick="javascript:addformpolicyannual()">
              ...
              <div class="form-group">
                ...
                <label>
                  <input type="radio" name="earningmethod" class="minimal"   onclick="javascript:addformpolicyhour()">
        ...
        <!-- /.box-header -->
        <div class="box-body" id="annualform" style="display:none; cursor: default">
         ...
         <!-- /.box-header -->
        <div class="box-body" id="hourform" style="display:none; cursor: default">
