...
@section('content')
    ...
    <section id="intro" class="intro" >
		...
		<div class="alert alert-danger">
	      ...
	      @endif
                    {!! Form::model($leavetype, ['method' => 'PATCH','data-parsley-validate','route' => ['LeaveType.update', $leavetype->id]]) !!}
    											...
    											<div class="col-xs-6 col-sm-6 col-md-6">
    												<div class="form-group">
    													 <label >Description :</label>
                                                                          ...
                                                                          <div class="radio">
                                                                            <label>
                                                                                {{ Form::radio('leaveduration', 'annualleave', ('annualleave'==$leavetype->leaveduration) ? true : '', ['class' => 'leaveduration']) }}
                                                                                Annual Leave (Maximum Days {{ $annualleave }} )</label>
                                                                          </div>
                                                                          <div class="radio">
                                                                              
                                                                              <label>
                                                                                {{ Form::radio('leaveduration','maternityleave', ('maternityleave'==$leavetype->leaveduration) ? true : '', ['class' => 'leaveduration']) }}
                                                                                Maternity Leave (Maximum Days {{ $maternityleave }} )</label>
                                                                          </div>
                                                                          <div class="radio disabled">
                                                                              
                                                                              <label>
                                                                                {{ Form::radio('leaveduration', 'sickleave', ('sickleave'==$leavetype->leaveduration) ? true : '', ['class' => 'leaveduration']) }}
                                                                                Sick Leave (Maximum Days {{ $sickleave }} )</label>
                                                                          </div>
                                                                          </div>    
