    ...
    <section id="intro" class="intro" >
		...
		<div class="alert alert-danger">
	      ...
	      @endif
                                   ...
                                   {!! Form::open(array('route' => 'LeaveType.store','method'=>'POST','enctype'=>'multipart/form-data','data-parsley-validate')) !!}
                                         <div class="row">
    													 ...
    													 <label >Description :</label>
                                                                          ...
                                                                          <div class="radio">
                                                                            <label>
                                                                                ...
                                                                                <input type="radio" name="leaveduration" value="annualleave" data-parsley-required="true">Annual Leave (Maximum Days {{ $annualleave }} )</label>
                                                                          </div>
                                                                          <div class="radio">
                                                                            <label><input type="radio" name="leaveduration" value="maternityleave">Maternity Leave (Maximum Days {{ $maternityleave }} )</label>
                                                                          </div>
                                                                          <div class="radio disabled">
                                                                            <label><input type="radio" name="leaveduration" value="sickleave">Sick Leave (Maximum Days {{ $sickleave }} )</label>
                                                                          </div>
                                                                          </div>    
