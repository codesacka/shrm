    ...
    <section id="intro" class="intro" >
		...
		<div class="alert alert-danger">
	      ...
	      @endif
                           ...
                           {!! Form::model($holiday, ['method' => 'PATCH','data-parsley-validate','route' => ['Holidays.update', $holiday->id]]) !!}  
    											...
    											<div class="col-xs-6 col-sm-6 col-md-6">
    												<div class="form-group">
    													<label>Recurrent : </label>
                                                                                                ...
                                                                                                {!! Form::select('recurrent', $recurrent,null,array('class' => 'form-control select2','data-parsley-error-message'=>"Recurrent select is required",'data-parsley-required'=>"true"))  !!}
                                                                                                        <div class="validation" > </div>
    												</div>
    											</div>
    											<div class="col-xs-6 col-sm-6 col-md-6">
