    ...
    <section id="intro" class="intro" >
		...
		<div class="alert alert-danger">
	      ...
	      @endif
                                   ...
                                   {!! Form::open(array('route' => 'Holidays.store','method'=>'POST','enctype'=>'multipart/form-data','data-parsley-validate')) !!}
                                         <div class="row">
    											...
    											<div class="col-xs-6 col-sm-6 col-md-6">
    												<div class="form-group">
    													 <label >Holiday Date :</label>
                                                                                                             ...
                                                                                                             {!! Form::text('holiday_date', null, array('placeholder' => 'Issued date','readonly' => 'true','class' => 'form-control datepicker' ,  'data-date-format'=>'yyyy-mm-dd','data-parsley-error-message'=>"Holiday Date is required",'data-parsley-required'=>"true")) !!}
    											...
    											<div class="col-xs-6 col-sm-6 col-md-6">
    												<div class="form-group">
    													<label>Recurrent : </label>
                                                                                                ...
                                                                                                {!! Form::select('recurrent', $recurrent,null,array('class' => 'form-control select2','data-parsley-error-message'=>"Recurrent is required",'data-parsley-required'=>"true"))  !!}
                                                                                                        <div class="validation" > </div>
    												</div>
    											</div>
    											<div class="col-xs-6 col-sm-6 col-md-6">
