    ...
    <section id="intro" class="intro" >
		...
		<div class="alert alert-danger">
	      ...
	      @endif
                               ...
                               {!! Form::model($role, ['method' => 'PATCH','data-parsley-validate','route' => ['roles.update', $role->id]]) !!}
                                 {{ csrf_field() }}
    											...
    											<div class="col-xs-6 col-sm-6 col-md-6">
    												<div class="form-group">
    													<label class="custom-control custom-checkbox">
                                                                                                            ...
                                                                                                            <span class="custom-control-description">  {{ $value->display_name }}</span>
                                                                                                          </label>
                                                                                                        <div class="validation" > </div>
    												</div>
    											</div>{{ Form::checkbox('permission[]', $value->id, in_array($value->id, $rolePermissions) ? true : false, array('class' => 'name')) }}
