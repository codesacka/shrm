						  ...
						  @if ($message = Session::get('success'))
							...
							<div class="panel-heading">
									...
									<div class="panel-body">
                                                                                     ...
                                                                                     @permission('license-add')
    					                                           <div class="panel-heading right">
                                                                                       <div class="tools">  <a class="btn btn-success" href="{{ route('License.create') }}"> <i class="fa fa-plus"></i></a>
    										...
    										@endpermission
                                                                          ...
                                                                          <table  class="table table-bordered table-striped datatable">
                                                                             <thead>
                                                                                    ...
                                                                                    <a class="btn btn-xs" href="{{ route('License.edit',$obj->id) }}"><i class="fa fa-pencil icon-success"></i></a>
                                                                                          @endpermission
