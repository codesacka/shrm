							...
							<div class="panel-heading">
									...
									<div class="panel-body">
    					                                           ...
    					                                           <div class="panel-heading right">
                                                                                       <div class="tools">  <a class="btn btn-success" href="{{ route('Locations.create') }}"> <i class="fa fa-plus"></i></a>
                                                                          ...
                                                                          <table  class="table table-bordered table-striped datatable">
                                                                            ...
                                                                            <tbody>
                                                                                  ...
                                                                                  <tr>
                                                                                    ...
                                                                                    <a class="btn btn-xs" href="{{ route('Locations.edit',$obj->id) }}"><i class="fa fa-pencil icon-success"></i></a>
                                                                                          @endpermission
