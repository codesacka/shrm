    ...
    <section id="intro" class="intro" >
		...
		<div class="alert alert-danger">
	      ...
	      @endif
                                   ...
                                   {!! Form::open(array('route' => 'Membership.store','method'=>'POST','enctype'=>'multipart/form-data','data-parsley-validate')) !!}
                                         <div class="row">
    										...
    										<div class="row">
    											<div class="col-xs-6 col-sm-6 col-md-6">
    												<div class="form-group">
    													  <label>Name (Membership to club or Organisation): </label>
