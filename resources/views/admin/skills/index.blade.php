							...
							<div class="panel-heading">
									...
									<div class="panel-body">
    					                                           ...
    					                                           <div class="panel-heading right">
                                                                                       <div class="tools">  <a class="btn btn-success" href="{{ route('Skill.create') }}"> <i class="fa fa-plus"></i></a>
    										...
    										@endpermission
                                                                          ...
                                                                          <table  class="table table-bordered table-striped datatable">
                                                                             <thead>
                                                                                    ...
                                                                                    <a class="btn btn-xs" href="{{ route('Skill.edit',$obj->id) }}"><i class="fa fa-pencil icon-success"></i></a>
                                                                                          @endpermission
                                                                                          @permission('skill-delete')
                                                                                    {!! Form::open(['method' => 'DELETE','route' => ['Skill.destroy', $obj->id],'style'=>'display:inline']) !!}
