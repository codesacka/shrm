						  ...
						  @if ($message = Session::get('success'))
							...
							<div class="panel-heading">
									...
									<div class="panel-body">
                                                                                     ...
                                                                                     @permission('jobtitle-add')
    					                                           <div class="panel-heading right">
                                                                                       <div class="tools">  <a class="btn btn-success" href="{{ route('JobTitle.create') }}"> <i class="fa fa-plus"></i></a>
    										...
    										@endpermission
                                                                          ...
                                                                          <table  class="table table-bordered table-striped datatable">
                                                                             <thead>
                                                                                    ...
                                                                                    <a class="btn btn-xs" href="{{ route('JobTitle.edit',$obj->id) }}"><i class="fa fa-pencil icon-success"></i></a>
                                                                                          @endpermission
...
<script>
    $(document).ready(function() {
     ...
     if (permission == null){
        $.blockUI({message:'Coming Soon Contact SpiceHrm to view this Module' , css: {
            border: 'none',
            padding: '15px',
            backgroundColor: '#fff',
