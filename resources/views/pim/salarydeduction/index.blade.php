    ...
    <section id="intro" class="intro" >
		...
		<div class="intro-content" >
			...
			<div class="container custom-container">
                              @permission('salarydeduction-view')
                           	<div class="row">
						  ...
						  @if ($message = Session::get('success'))
							...
							<div class="panel-heading">
									...
									<div class="panel-body">
                                                                                     ...
                                                                                     @permission('salarydeduction-add')
    					                                           <div class="panel-heading right">
                                                                                       <div class="tools">  <a class="btn btn-success" href="{{ route('SalaryDeduction.create') }}"> <i class="fa fa-plus"></i></a>
                                      ...
                                      <table  class="table borderless table-striped datatable">
                                         <thead>
                                                ...
                                                <a class="btn btn-xs" href="{{ route('SalaryDeduction.edit',$obj->id) }}"><i class="fa fa-pencil icon-success"></i></a>
                                                      @endpermission
                                                      @permission('salarydeduction-delete')
                                                {!! Form::open(['method' => 'DELETE','route' => ['SalaryDeduction.destroy', $obj->id],'style'=>'display:inline']) !!}
