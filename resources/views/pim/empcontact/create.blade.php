  ...
  <div class="tingle-demo addemployeecontactform" style="display:none; cursor: default">
     
     
   {!! Form::open(array('route' => 'ContactDetails.store','method'=>'POST','data-parsley-validate')) !!}
    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title" style="float: left;">Add Employee  Contacts</h3>
