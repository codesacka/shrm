             ...
             <div class="form-group">
                <div class="input-group date">
                  <div class="input-group-addon">
                    ...
                    {!! Form::text('dateto', null, array('placeholder' => 'Payment Date to','class' => 'form-control datepicker pull-right' , 'data-date-format'=>'yyyy-mm-dd')) !!}
              ...
              <!-- /.form group -->
                  ...
                  <div class="form-group row">
                    <div class=" col-sm-10">
                      ...
                      {!! Form::hidden('processor', 2, array('id' => 'processor')) !!}
