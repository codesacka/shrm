                                                                              ...
                                                                              <div class="col-sm-12">
                                                                                            ...
                                                                                            <div class="wizard-container">
                                                                                                ...
                                                                                                <div class="card wizard-card" data-color="orange" id="wizardProfile">
                                                                                                  {!! Form::open(array('route' => 'SalaryBenefit.store','method'=>'POST')) !!}
                                                                                                ...
                                                                                                <!--        You can switch ' data-color="orange" '  with one of the next bright colors: "blue", "green", "orange", "red"          -->
                                                                                                                ...
                                                                                                                <div class="row">
                                                                                                                    ...
                                                                                                                    <div class="col-sm-10">
                                                                                                                            ...
                                                                                                                            @foreach($plancoverage as $obj)
                                                                                                                              <div class="checkbox">
                                                                                                                                <label>
                                                                                                                                     {{ Form::checkbox('plancoverage[]', $obj->id, false, array('class' => 'name','required'=>'true')) }}
                                                                                                                                     {{ $obj->name }}</label>
                                                                                                                              </div>
                                                                                                                            @endforeach
                                                                                                            ...
                                                                                                            <div class="tab-pane" id="address">
                                                                                                                <div class="row">
                                                                                                                    ...
                                                                                                                    <div class="col-sm-7 col-sm-offset-1">
                                                                                                                        ...
                                                                                                                        <div class="checkbox">
                                                                                                                            <label>{!! Form::checkbox('deductemployee', '1') !!}  Deduct from  Employee</label>
                                                                                                                          </div>
                                                                                                                      </div>
                                                                                                        ...
                                                                                                        <div class="wizard-footer height-wizard">
                                                                                                            ...
                                                                                                            <div class="pull-left">
                                                                                                                        {!! Form::hidden('benefit', $id, array('id' => 'benefit')) !!}
