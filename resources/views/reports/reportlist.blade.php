		...
		<div class="intro-content" >
			...
			<div class="container custom-container">
				...
				<div class="row">
                   ...
                   <h2 class="panel-title heading-sm pull-left" style="font-weight:bold;color:#555;"><i class="fa fa-pie-chart"></i>Reports</h2>
                                                                                             ...
                                                                                             <table  class="table table-bordered table-striped">
                                                                                                 ...
                                                                                                 <thead>
                                                                                                           ...
                                                                                                           <tbody>
                                                                                                             ...
                                                                                                             @foreach (\Config::get('constants.report') as $module=>$submod)


                                                                                                                           <tr>
                                                                                                                             <td><a href="{{ url($module) }}">{{ $submod }}</a>
                                                                                                                             </td>
