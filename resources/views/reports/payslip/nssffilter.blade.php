		...
		<div class="intro-content" >
			...
			<div class="container custom-container">
				...
				<div class="row">
                   ...
                   <h2 class="panel-title heading-sm pull-left" style="font-weight:bold;color:#555;"><i class="fa fa-pie-chart"></i>Select Nssf Period </h2>
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                                  ...
                                  {!! Form::open(array('route' => 'Payslip.NssfReport','method'=>'GET','data-parsley-validate')) !!}
